...
public class Menu_color_change : MonoBehaviour
{
    ...
    {
        Select_Random_Color();
        //Select_Random_Color2(); another solution, but it does not look that great
        //Select_Random_Color3(); random color, causes eye bleed
    }

    private void Select_Random_Color3()
    {
    ...
    private void Select_Random_Color2()
    {
